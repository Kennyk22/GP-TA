  ...
  return (
    <>
      ...
      <div className="relative mb-4">
        ...
        <button onClick={handleSubmit} className="text-white font-bold bg-black border-0 py-2 px-8 focus:outline-none hover:bg-red-700 hover:text-black rounded text-lg">Add new student</button>
    </div>
        </>
      ) : null}
    </>
