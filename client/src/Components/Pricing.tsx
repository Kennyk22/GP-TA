...
<section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <div className="flex mx-auto border-2 border-[#ebbab9] rounded overflow-hidden mt-6">
        <button className="py-1 px-4 bg-[#ebbab9] text-black focus:outline-none">Monthly</button>
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          ...
          <button className="flex items-center mt-auto text-black bg-gray-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded">Stripegi
      ...
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-[#ebbab9] flex flex-col relative overflow-hidden">
          <span className="bg-[#ebbab9] text-black px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">POPULAR</span>
          ...
          <button className="flex items-center mt-auto text-black bg-[#ebbab9] border-0 py-2 px-4 w-full focus:outline-none hover:bg-pink-600 rounded">Stripe
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
