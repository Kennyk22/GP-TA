...
export default {
    aiPost: async (ctx: Context) => {
        try {
            ...
            // SECOND AI CALL
            const aiResponse2 = await openai.createCompletion(aiProp("provide a numbered list of grammatical errors in this text with a short explanation and its correction" + content));
